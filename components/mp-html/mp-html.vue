 ...
 */
const plugins=[require('./markdown/index.js'),require('./emoji/index.js'),require('./highlight/index.js'),require('./editable/index.js'),]
...
export default {
  ...
  methods: {
     ...
     * @returns {Promise}
     */
    navigateTo(id, offset){id=this._ids[decodeURI(id)]||id

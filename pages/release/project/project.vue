<template>
	<view>
		<view>
			<u-navbar back-text="返回" title="发布项目" :is-fixed="true" :background="background" :back-text-style="color"
			...
			<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
				...
				<u-form-item prop="sex">
					<u-input :border="border" type="select" :select-open="actionSheetShow" v-model="model.sex"
						placeholder="项目性质" @click="actionSheetShow = true"></u-input>
				</u-form-item>
